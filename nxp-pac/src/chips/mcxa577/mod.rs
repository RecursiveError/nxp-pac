...
pub const CAN0: can5xx::Can5xx = unsafe { can5xx::Can5xx::from_ptr(0x400CC000 as _) };
pub const CAN1: can5xx::Can5xx = unsafe { can5xx::Can5xx::from_ptr(0x400D0000 as _) };
...
pub mod ahbsc;
#[path = "../../meta_peripherals/mcxa/CAN5xx.rs"]
pub mod can5xx;
