...
pub const CAN0: can2xx::Can2xx = unsafe { can2xx::Can2xx::from_ptr(0x400CC000 as _) };
pub const CAN1: can2xx::Can2xx = unsafe { can2xx::Can2xx::from_ptr(0x400D0000 as _) };
...
pub mod adc;
#[path = "../../meta_peripherals/mcxa/CAN2xx.rs"]
pub mod can2xx;
