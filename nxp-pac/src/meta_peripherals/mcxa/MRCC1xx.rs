...
impl Mrcc {
    ...
    #[inline(always)]
    pub const fn mrcc_adc1_clkdiv(self) -> crate::pac::common::Reg<Clkdiv, crate::pac::common::RW> {
    ...
    pub const fn mrcc_fro_hf_div_clkdiv(
        self,
    ) -> crate::pac::common::Reg<ClkdivFro, crate::pac::common::RW> {
...
impl Default for ClkdivFro {
    #[inline(always)]
    fn default() -> ClkdivFro {
        ClkdivFro(0)
    }
}
impl core::fmt::Debug for ClkdivFro {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ClkdivFro")
            .field("div", &self.div())
            .field("unstab", &self.unstab())
            .finish()
    }
...
#[cfg(feature = "defmt")]
impl defmt::Format for ClkdivFro {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "ClkdivFro {{ div: {=u8:?}, unstab: {:?} }}",
            self.div(),
            self.unstab()
        )
    }
...
impl defmt::Format for GlbAcc1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "GlbAcc1 {{ ostimer0: {=bool:?}, adc0: {=bool:?}, adc1: {=bool:?}, cmp0: {=bool:?}, cmp1: {=bool:?}, dac0: {=bool:?}, opamp0: {=bool:?}, port0: {=bool:?}, port1: {=bool:?}, port2: {=bool:?}, port3: {=bool:?}, port4: {=bool:?}, flexcan0: {=bool:?}, lpi2c2: {=bool:?}, lpi2c3: {=bool:?}, rama: {=bool:?}, ramb: {=bool:?}, gpio0: {=bool:?}, gpio1: {=bool:?}, gpio2: {=bool:?}, gpio3: {=bool:?}, gpio4: {=bool:?}, romc: {=bool:?} }}",
            self.ostimer0(),
            self.adc0(),
            self.adc1(),
            self.cmp0(),
...
impl defmt::Format for GlbCc1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "GlbCc1 {{ ostimer0: {=bool:?}, adc0: {=bool:?}, adc1: {=bool:?}, cmp0: {=bool:?}, cmp1: {=bool:?}, dac0: {=bool:?}, opamp0: {=bool:?}, port0: {=bool:?}, port1: {=bool:?}, port2: {=bool:?}, port3: {=bool:?}, port4: {=bool:?}, flexcan0: {=bool:?}, lpi2c2: {=bool:?}, lpi2c3: {=bool:?}, rama: {=bool:?}, ramb: {=bool:?}, gpio0: {=bool:?}, gpio1: {=bool:?}, gpio2: {=bool:?}, gpio3: {=bool:?}, gpio4: {=bool:?}, romc: {=bool:?} }}",
            self.ostimer0(),
            self.adc0(),
            self.adc1(),
            self.cmp0(),
...
impl defmt::Format for GlbRst1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "GlbRst1 {{ ostimer0: {=bool:?}, adc0: {=bool:?}, adc1: {=bool:?}, cmp1: {=bool:?}, dac0: {=bool:?}, opamp0: {=bool:?}, port0: {=bool:?}, port1: {=bool:?}, port2: {=bool:?}, port3: {=bool:?}, port4: {=bool:?}, flexcan0: {=bool:?}, lpi2c2: {=bool:?}, lpi2c3: {=bool:?}, gpio0: {=bool:?}, gpio1: {=bool:?}, gpio2: {=bool:?}, gpio3: {=bool:?}, gpio4: {=bool:?} }}",
            self.ostimer0(),
            self.adc0(),
            self.adc1(),
            self.cmp1(),
