...
impl Can {
    ...
    #[doc = "Debug 1."]
    #[inline(always)]
    pub const fn dbg1(self) -> crate::pac::common::Reg<Dbg1, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x58usize) as _) }
    }
    #[doc = "Debug 2."]
    #[inline(always)]
    pub const fn dbg2(self) -> crate::pac::common::Reg<Dbg2, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x5cusize) as _) }
    }
    #[doc = "External Timer."]
    #[inline(always)]
    pub const fn et(self) -> crate::pac::common::Reg<Et, crate::pac::common::R> {
        unsafe { crate::pac::common::Reg::from_ptr(self.ptr.wrapping_add(0x78usize) as _) }
    }
    #[doc = "Fault Confinement Interrupt Enable."]
    #[inline(always)]
    pub const fn fltconf_ie(self) -> crate::pac::common::Reg<FltconfIe, crate::pac::common::RW> {
...
impl Ctrl2 {
    ...
    pub const fn retry(&self) -> Retry {
        ...
        Retry::from_bits(val as u8)
    }
    #[doc = "Number of Retransmission Requests."]
    #[inline(always)]
    pub const fn set_retry(&mut self, val: Retry) {
...
impl defmt::Format for Ctrl2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl2 {{ retry: {:?}, flt_rxn: {=bool:?}, bte: {=bool:?}, eacen: {:?}, rrs: {:?}, mrp: {:?}, tasd: {=u8:?}, rffn: {=u8:?}, boffdonemsk: {=bool:?}, errmsk_fast: {=bool:?} }}",
            self.retry(),
            self.flt_rxn(),
            self.bte(),
            self.eacen(),
...
impl Dbg1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn cbn(&self) -> u16 {
        let val = (self.0 >> 16usize) & 0x03ff;
        val as u16
    }
    #[doc = "CAN Bit Number."]
    #[inline(always)]
    pub const fn set_cbn(&mut self, val: u16) {
...
impl Dbg2 {
    ...
    pub const fn mpp(&self) -> Mpp {
        let val = (self.0 >> 7usize) & 0x01;
        Mpp::from_bits(val as u8)
    }
    #[doc = "Matching Process in Progress."]
    #[inline(always)]
    pub const fn set_mpp(&mut self, val: Mpp) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    ...
    pub const fn app(&self) -> App {
        let val = (self.0 >> 15usize) & 0x01;
        App::from_bits(val as u8)
    }
    #[doc = "Arbitration Process in Progress."]
    #[inline(always)]
    pub const fn set_app(&mut self, val: App) {
        self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
    }
}
...
impl Esr2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn rx_pin_st(&self) -> RxPinSt {
        let val = (self.0 >> 12usize) & 0x01;
        RxPinSt::from_bits(val as u8)
    }
    #[doc = "RX Pin Status."]
    #[inline(always)]
    pub const fn set_rx_pin_st(&mut self, val: RxPinSt) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
...
impl Mcr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn tpov(&self) -> Tpov {
        let val = (self.0 >> 10usize) & 0x01;
        Tpov::from_bits(val as u8)
    }
    #[doc = "TX Pin Override Value."]
    #[inline(always)]
    pub const fn set_tpov(&mut self, val: Tpov) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
...
impl Tcr {
    #[doc = "Discard Acknowledge."]
    #[must_use]
    #[inline(always)]
    pub const fn dscack(&self) -> Dscack {
        let val = (self.0 >> 8usize) & 0x01;
        Dscack::from_bits(val as u8)
    }
    #[doc = "Discard Acknowledge."]
    #[inline(always)]
    pub const fn set_dscack(&mut self, val: Dscack) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "Output Bit Clock."]
    #[must_use]
    #[inline(always)]
    pub const fn bit_cls(&self) -> BitCls {
        let val = (self.0 >> 9usize) & 0x01;
        BitCls::from_bits(val as u8)
    }
    #[doc = "Output Bit Clock."]
    #[inline(always)]
    pub const fn set_bit_cls(&mut self, val: BitCls) {
        self.0 = (self.0 & !(0x01 << 9usize)) | (((val.to_bits() as u32) & 0x01) << 9usize);
    }
    #[doc = "Test Read."]
    #[must_use]
    #[inline(always)]
    pub const fn trd(&self) -> bool {
        let val = (self.0 >> 10usize) & 0x01;
        val != 0
    }
    #[doc = "Test Read."]
    #[inline(always)]
    pub const fn set_trd(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
    }
}
...
impl core::fmt::Debug for Tcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Tcr")
            .field("dscack", &self.dscack())
            .field("bit_cls", &self.bit_cls())
            .field("trd", &self.trd())
            .finish()
    }
}
...
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum App {
    #[doc = "No arbitration process ongoing."]
    ProcessNo = 0x0,
    #[doc = "Arbitration process is in progress."]
    ProcessYes = 0x01,
}
impl App {
    #[inline(always)]
...
pub enum BitCls {
    #[doc = "No such occurrence."]
    OutputBitClockNotSample = 0x0,
    #[doc = "Internal FlexCAN bit clock on ipp_do_cantx pin."]
    OutputBitClockSample = 0x01,
}
impl BitCls {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> BitCls {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for BitCls {
    #[inline(always)]
    fn from(val: u8) -> BitCls {
        BitCls::from_bits(val)
    }
}
impl From<BitCls> for u8 {
    #[inline(always)]
    fn from(val: BitCls) -> u8 {
        BitCls::to_bits(val)
    }
}
#[repr(u8)]
...
pub enum Dscack {
    #[doc = "No such occurrence."]
    AcknowledgeBitDiscardNo = 0x0,
    #[doc = "Discard acknowledge bit."]
    AcknowledgeBitDiscardYes = 0x01,
}
impl Dscack {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> Dscack {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for Dscack {
    #[inline(always)]
    fn from(val: u8) -> Dscack {
        Dscack::from_bits(val)
    }
}
impl From<Dscack> for u8 {
    #[inline(always)]
    fn from(val: Dscack) -> u8 {
        Dscack::to_bits(val)
    }
}
#[repr(u8)]
